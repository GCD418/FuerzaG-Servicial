...
namespace TechnicianService.Application.Services
{
    public class TechnicianService
    {
        ...
        public async Task<bool> Update(Technician t)               => await _repository.UpdateAsync(t);
        public async Task<bool> DeleteById(int id)                 => await _repository.DeleteByIdAsync(id);
    }
}
